...
import Input, { InputSelectGrouped } from "../../Controls/Input";
...
const NewIdentificationDialog = (props: any) => {
  ...
  const handleInputChangeSiteName = (arg: any) => {
    handleInputChange(arg);
    dispatch(searchSiteNameFromClearbit(arg.target.value));
  };
          ...
          <Grid container spacing={2}>
            <Grid item xs={12} sm={6}>
              <InputSelectGrouped
                ...
                fullWidth={true}
                autofocus={true}
                onChange={handleInputChangeSiteName}
